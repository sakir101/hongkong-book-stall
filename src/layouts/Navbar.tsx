...
export default function Navbar() {
  ...
  const menuItems = (
    <>
      ...
      <p className="text-base font-bold mt-3 text-white hidden lg:block">
    ...
    <>
      <div>
        <div className="navbar bg-gradient-to-r from-blue-900 via-blue-700 to-blue-500">
          <div className="w-full lg:w-1/2 flex justify-between lg:justify-between">
            <div className="flex">
              <div className="dropdown">
                ...
                <ul
                  tabIndex={2}
                  className="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52 text-xl text-black z-50"
                >
                  {menuItems}
                </ul>
              </div>
